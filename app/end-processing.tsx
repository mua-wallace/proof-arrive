...
export default function EndProcessingScreen() {
  ...
  const handleEndProcessing = async () => {
    ...
    try {
      ...
      await updateArrivalStatus(arrivalId, 'ready_to_exit', endTime);
      ...
      setError(err instanceof Error ? err.message : 'Failed to end processing');
    }
  };
    ...
    return (
      <ThemedView style={styles.container}>
        <View style={styles.loadingContainer}>
          ...
          <ThemedText style={styles.loadingText}>Ending processing...</ThemedText>
        </View>
      </ThemedView>
    );
  }
    ...
    <ThemedView style={styles.container}>
      <View style={styles.content}>
        <View style={[styles.iconContainer, { backgroundColor: tintColor + '20' }]}>
          <MaterialIcons name="check-circle-outline" size={64} color={tintColor} />
        </View>
        ...
        <ThemedText style={styles.description}>
          Mark this vehicle's processing as complete. The vehicle will be ready to exit.
        </ThemedText>
